...
${erTextTruncated}`
  ...
  logApiUsage({ companyId: project?.company_id ?? null, endpoint: 'er-extract-tasks', model: message.model, inputTokens: message.usage.input_tokens, outputTokens: message.usage.output_tokens }).catch(() => {})
