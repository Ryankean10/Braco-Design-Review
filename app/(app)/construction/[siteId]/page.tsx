...
import { ArrowLeft, HardHat, BookOpen, FileBarChart2, FileQuestion, ClipboardList } from 'lucide-react'
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <CollapsibleSection
        ...
        summary="Generate and view today's AI-assisted site brief — personnel, works, weather, H&S"
      >
        <div className="p-4 text-sm" style={{ color: 'var(--text-muted)' }}>
          <a href={`/construction/${siteId}/daily-brief`} className="underline" style={{ color: 'var(--accent)' }}>
            Open Daily Brief →
          </a>
        </div>
      </CollapsibleSection>
